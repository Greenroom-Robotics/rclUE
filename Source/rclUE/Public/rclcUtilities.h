...
DECLARE_LOG_CATEGORY_EXTERN(LogROS2NodeSubsystem, Log, All);
DECLARE_LOG_CATEGORY_EXTERN(LogROS2ParameterSubsystem, Log, All);
  ...
  {                                                                                                            \
    ...
    {                                                                                                          \
      UE_LOG(LogTemp, Error,                                                                                   \
             TEXT("RCL error %d: %s (%s)"), (int)rc, *FString(rcutils_get_error_string().str), *__LOG_INFO__); \
      rcutils_reset_error();                                                                                   \
    }                                                                                                          \
    else                                                                                                       \
    {                                                                                                          \
      UE_LOG(LogTemp, Error, TEXT("RCL error %d (%s)."), (int)rc, *__LOG_INFO__);                              \
    }                                                                                                          \
  }
...
public:
  ...
  rmw_time_t ToRMW() { return { static_cast<uint64>(Seconds), static_cast<uint64>(Nanoseconds) }; }
};
...
public:
  ...
  {
    return { UROS2QosHistoryPolicy_LUT[QosHistoryPolicy],
             (uint32)QosDepth,
