...
public:
  virtual void Init() override { geometry_msgs__msg__AccelStamped__init(&accel_stamped_msg); }

  virtual void Fini() override { geometry_msgs__msg__AccelStamped__fini(&accel_stamped_msg); }
  ...
  void SetMsg(const FROSAccelStamped& Input) { Input.SetROS2(accel_stamped_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSAccelStamped& Output) const { Output.SetFromROS2(accel_stamped_msg); }

  virtual void* Get() override { return &accel_stamped_msg; }
