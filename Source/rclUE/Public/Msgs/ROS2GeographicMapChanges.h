...
public:
  virtual void Init() override { geographic_msgs__msg__GeographicMapChanges__init(&geographic_map_changes_msg); }

  virtual void Fini() override { geographic_msgs__msg__GeographicMapChanges__fini(&geographic_map_changes_msg); }
  ...
  void SetMsg(const FROSGeographicMapChanges& Input) { Input.SetROS2(geographic_map_changes_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSGeographicMapChanges& Output) const { Output.SetFromROS2(geographic_map_changes_msg); }

  virtual void* Get() override { return &geographic_map_changes_msg; }
