...
public:
  virtual void Init() override { nav_msgs__msg__OccupancyGrid__init(&occupancy_grid_msg); }

  virtual void Fini() override { nav_msgs__msg__OccupancyGrid__fini(&occupancy_grid_msg); }
  ...
  void SetMsg(const FROSOccupancyGrid& Input) { Input.SetROS2(occupancy_grid_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSOccupancyGrid& Output) const { Output.SetFromROS2(occupancy_grid_msg); }

  virtual void* Get() override { return &occupancy_grid_msg; }
