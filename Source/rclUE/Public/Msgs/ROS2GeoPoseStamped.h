...
public:
  virtual void Init() override { geographic_msgs__msg__GeoPoseStamped__init(&geo_pose_stamped_msg); }

  virtual void Fini() override { geographic_msgs__msg__GeoPoseStamped__fini(&geo_pose_stamped_msg); }
  ...
  void SetMsg(const FROSGeoPoseStamped& Input) { Input.SetROS2(geo_pose_stamped_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSGeoPoseStamped& Output) const { Output.SetFromROS2(geo_pose_stamped_msg); }

  virtual void* Get() override { return &geo_pose_stamped_msg; }
