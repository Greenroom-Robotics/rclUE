...
public:
  virtual void Init() override { sensor_msgs__msg__LaserScan__init(&laser_scan_msg); }

  virtual void Fini() override { sensor_msgs__msg__LaserScan__fini(&laser_scan_msg); }
  ...
  void SetMsg(const FROSLaserScan& Input) { Input.SetROS2(laser_scan_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSLaserScan& Output) const { Output.SetFromROS2(laser_scan_msg); }

  virtual void* Get() override { return &laser_scan_msg; }
