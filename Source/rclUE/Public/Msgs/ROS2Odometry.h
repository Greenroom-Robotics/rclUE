...
public:
  virtual void Init() override { nav_msgs__msg__Odometry__init(&odometry_msg); }

  virtual void Fini() override { nav_msgs__msg__Odometry__fini(&odometry_msg); }
  ...
  void SetMsg(const FROSOdometry& Input) { Input.SetROS2(odometry_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSOdometry& Output) const { Output.SetFromROS2(odometry_msg); }

  virtual void* Get() override { return &odometry_msg; }
