...
public:
  ...
  void SetMsg(const FROSPoseWithCovarianceStamped& Input) { Input.SetROS2(pose_with_covariance_stamped_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSPoseWithCovarianceStamped& Output) const { Output.SetFromROS2(pose_with_covariance_stamped_msg); }

  virtual void* Get() override { return &pose_with_covariance_stamped_msg; }
