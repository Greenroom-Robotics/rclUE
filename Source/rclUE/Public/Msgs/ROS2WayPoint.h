...
public:
  virtual void Init() override { geographic_msgs__msg__WayPoint__init(&way_point_msg); }

  virtual void Fini() override { geographic_msgs__msg__WayPoint__fini(&way_point_msg); }
  ...
  void SetMsg(const FROSWayPoint& Input) { Input.SetROS2(way_point_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSWayPoint& Output) const { Output.SetFromROS2(way_point_msg); }

  virtual void* Get() override { return &way_point_msg; }
