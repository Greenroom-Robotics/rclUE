...
public:
  virtual void Init() override { geometry_msgs__msg__TransformStamped__init(&transform_stamped_msg); }

  virtual void Fini() override { geometry_msgs__msg__TransformStamped__fini(&transform_stamped_msg); }
  ...
  void SetMsg(const FROSTransformStamped& Input) { Input.SetROS2(transform_stamped_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSTransformStamped& Output) const { Output.SetFromROS2(transform_stamped_msg); }

  virtual void* Get() override { return &transform_stamped_msg; }
