...
public:
  virtual void Init() override { std_msgs__msg__Header__init(&header_msg); }

  virtual void Fini() override { std_msgs__msg__Header__fini(&header_msg); }
  ...
  void SetMsg(const FROSHeader& Input) { Input.SetROS2(header_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSHeader& Output) const { Output.SetFromROS2(header_msg); }

  virtual void* Get() override { return &header_msg; }
