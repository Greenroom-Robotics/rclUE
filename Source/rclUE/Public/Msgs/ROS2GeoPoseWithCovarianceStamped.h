...
public:
  ...
  void SetMsg(const FROSGeoPoseWithCovarianceStamped& Input) { Input.SetROS2(geo_pose_with_covariance_stamped_msg); }
  ...
  virtual void* Get() override { return &geo_pose_with_covariance_stamped_msg; }
