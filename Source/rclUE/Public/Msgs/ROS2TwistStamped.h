...
public:
  virtual void Init() override { geometry_msgs__msg__TwistStamped__init(&twist_stamped_msg); }

  virtual void Fini() override { geometry_msgs__msg__TwistStamped__fini(&twist_stamped_msg); }
  ...
  void SetMsg(const FROSTwistStamped& Input) { Input.SetROS2(twist_stamped_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSTwistStamped& Output) const { Output.SetFromROS2(twist_stamped_msg); }

  virtual void* Get() override { return &twist_stamped_msg; }
