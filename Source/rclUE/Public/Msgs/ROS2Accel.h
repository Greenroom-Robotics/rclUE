...
public:
  virtual void Init() override { geometry_msgs__msg__Accel__init(&accel_msg); }

  virtual void Fini() override { geometry_msgs__msg__Accel__fini(&accel_msg); }
  ...
  void SetMsg(const FROSAccel& Input) { Input.SetROS2(accel_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSAccel& Output) const { Output.SetFromROS2(accel_msg); }

  virtual void* Get() override { return &accel_msg; }
