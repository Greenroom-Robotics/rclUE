...
public:
  virtual void Init() override { action_msgs__msg__GoalInfo__init(&goal_info_msg); }

  virtual void Fini() override { action_msgs__msg__GoalInfo__fini(&goal_info_msg); }
  ...
  void SetMsg(const FROSGoalInfo& Input) { Input.SetROS2(goal_info_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSGoalInfo& Output) const { Output.SetFromROS2(goal_info_msg); }

  virtual void* Get() override { return &goal_info_msg; }
