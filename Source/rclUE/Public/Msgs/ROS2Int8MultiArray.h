...
public:
  virtual void Init() override { example_interfaces__msg__Int8MultiArray__init(&int8_multi_array_msg); }

  virtual void Fini() override { example_interfaces__msg__Int8MultiArray__fini(&int8_multi_array_msg); }
  ...
  void SetMsg(const FROSInt8MultiArray& Input) { Input.SetROS2(int8_multi_array_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSInt8MultiArray& Output) const { Output.SetFromROS2(int8_multi_array_msg); }

  virtual void* Get() override { return &int8_multi_array_msg; }
