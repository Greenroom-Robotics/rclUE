...
public:
  virtual void Init() override { geometry_msgs__msg__InertiaStamped__init(&inertia_stamped_msg); }

  virtual void Fini() override { geometry_msgs__msg__InertiaStamped__fini(&inertia_stamped_msg); }
  ...
  void SetMsg(const FROSInertiaStamped& Input) { Input.SetROS2(inertia_stamped_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSInertiaStamped& Output) const { Output.SetFromROS2(inertia_stamped_msg); }

  virtual void* Get() override { return &inertia_stamped_msg; }
