...
public:
  virtual void Init() override { example_interfaces__msg__UInt64MultiArray__init(&u_int64_multi_array_msg); }

  virtual void Fini() override { example_interfaces__msg__UInt64MultiArray__fini(&u_int64_multi_array_msg); }
  ...
  void SetMsg(const FROSUInt64MultiArray& Input) { Input.SetROS2(u_int64_multi_array_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSUInt64MultiArray& Output) const { Output.SetFromROS2(u_int64_multi_array_msg); }

  virtual void* Get() override { return &u_int64_multi_array_msg; }
