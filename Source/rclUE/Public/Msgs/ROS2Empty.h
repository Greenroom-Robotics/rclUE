...
public:
  virtual void Init() override { example_interfaces__msg__Empty__init(&empty_msg); }

  virtual void Fini() override { example_interfaces__msg__Empty__fini(&empty_msg); }
  ...
  void SetMsg(const FROSEmpty& Input) { Input.SetROS2(empty_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSEmpty& Output) const { Output.SetFromROS2(empty_msg); }

  virtual void* Get() override { return &empty_msg; }
