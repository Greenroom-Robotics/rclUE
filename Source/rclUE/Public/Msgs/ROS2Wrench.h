...
public:
  virtual void Init() override { geometry_msgs__msg__Wrench__init(&wrench_msg); }

  virtual void Fini() override { geometry_msgs__msg__Wrench__fini(&wrench_msg); }
  ...
  void SetMsg(const FROSWrench& Input) { Input.SetROS2(wrench_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSWrench& Output) const { Output.SetFromROS2(wrench_msg); }

  virtual void* Get() override { return &wrench_msg; }
