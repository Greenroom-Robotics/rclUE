...
public:
  virtual void Init() override { geometry_msgs__msg__QuaternionStamped__init(&quaternion_stamped_msg); }

  virtual void Fini() override { geometry_msgs__msg__QuaternionStamped__fini(&quaternion_stamped_msg); }
  ...
  void SetMsg(const FROSQuaternionStamped& Input) { Input.SetROS2(quaternion_stamped_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSQuaternionStamped& Output) const { Output.SetFromROS2(quaternion_stamped_msg); }

  virtual void* Get() override { return &quaternion_stamped_msg; }
