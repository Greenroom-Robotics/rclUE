...
public:
  virtual void Init() override { nav_msgs__msg__GridCells__init(&grid_cells_msg); }

  virtual void Fini() override { nav_msgs__msg__GridCells__fini(&grid_cells_msg); }
  ...
  void SetMsg(const FROSGridCells& Input) { Input.SetROS2(grid_cells_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSGridCells& Output) const { Output.SetFromROS2(grid_cells_msg); }

  virtual void* Get() override { return &grid_cells_msg; }
