...
public:
  virtual void Init() override { geometry_msgs__msg__WrenchStamped__init(&wrench_stamped_msg); }

  virtual void Fini() override { geometry_msgs__msg__WrenchStamped__fini(&wrench_stamped_msg); }
  ...
  void SetMsg(const FROSWrenchStamped& Input) { Input.SetROS2(wrench_stamped_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSWrenchStamped& Output) const { Output.SetFromROS2(wrench_stamped_msg); }

  virtual void* Get() override { return &wrench_stamped_msg; }
