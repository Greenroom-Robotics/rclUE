...
public:
  virtual void Init() override { sensor_msgs__msg__Joy__init(&joy_msg); }

  virtual void Fini() override { sensor_msgs__msg__Joy__fini(&joy_msg); }
  ...
  void SetMsg(const FROSJoy& Input) { Input.SetROS2(joy_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSJoy& Output) const { Output.SetFromROS2(joy_msg); }

  virtual void* Get() override { return &joy_msg; }
