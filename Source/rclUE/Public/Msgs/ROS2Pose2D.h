...
public:
  virtual void Init() override { geometry_msgs__msg__Pose2D__init(&pose2_d_msg); }

  virtual void Fini() override { geometry_msgs__msg__Pose2D__fini(&pose2_d_msg); }
  ...
  void SetMsg(const FROSPose2D& Input) { Input.SetROS2(pose2_d_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSPose2D& Output) const { Output.SetFromROS2(pose2_d_msg); }

  virtual void* Get() override { return &pose2_d_msg; }
