...
public:
  virtual void Init() override { geometry_msgs__msg__PoseArray__init(&pose_array_msg); }

  virtual void Fini() override { geometry_msgs__msg__PoseArray__fini(&pose_array_msg); }
  ...
  void SetMsg(const FROSPoseArray& Input) { Input.SetROS2(pose_array_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSPoseArray& Output) const { Output.SetFromROS2(pose_array_msg); }

  virtual void* Get() override { return &pose_array_msg; }
