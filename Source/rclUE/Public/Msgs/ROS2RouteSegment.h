...
public:
  virtual void Init() override { geographic_msgs__msg__RouteSegment__init(&route_segment_msg); }

  virtual void Fini() override { geographic_msgs__msg__RouteSegment__fini(&route_segment_msg); }
  ...
  void SetMsg(const FROSRouteSegment& Input) { Input.SetROS2(route_segment_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSRouteSegment& Output) const { Output.SetFromROS2(route_segment_msg); }

  virtual void* Get() override { return &route_segment_msg; }
