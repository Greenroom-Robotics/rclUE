...
public:
  virtual void Init() override { sensor_msgs__msg__NavSatStatus__init(&nav_sat_status_msg); }

  virtual void Fini() override { sensor_msgs__msg__NavSatStatus__fini(&nav_sat_status_msg); }
  ...
  void SetMsg(const FROSNavSatStatus& Input) { Input.SetROS2(nav_sat_status_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSNavSatStatus& Output) const { Output.SetFromROS2(nav_sat_status_msg); }

  virtual void* Get() override { return &nav_sat_status_msg; }
