...
public:
  virtual void Init() override { example_interfaces__msg__ByteMultiArray__init(&byte_multi_array_msg); }

  virtual void Fini() override { example_interfaces__msg__ByteMultiArray__fini(&byte_multi_array_msg); }
  ...
  void SetMsg(const FROSByteMultiArray& Input) { Input.SetROS2(byte_multi_array_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSByteMultiArray& Output) const { Output.SetFromROS2(byte_multi_array_msg); }

  virtual void* Get() override { return &byte_multi_array_msg; }
