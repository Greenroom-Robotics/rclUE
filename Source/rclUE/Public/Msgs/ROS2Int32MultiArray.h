...
public:
  virtual void Init() override { example_interfaces__msg__Int32MultiArray__init(&int32_multi_array_msg); }

  virtual void Fini() override { example_interfaces__msg__Int32MultiArray__fini(&int32_multi_array_msg); }
  ...
  void SetMsg(const FROSInt32MultiArray& Input) { Input.SetROS2(int32_multi_array_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSInt32MultiArray& Output) const { Output.SetFromROS2(int32_multi_array_msg); }

  virtual void* Get() override { return &int32_multi_array_msg; }
