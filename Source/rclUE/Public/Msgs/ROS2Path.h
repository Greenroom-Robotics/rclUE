...
public:
  virtual void Init() override { nav_msgs__msg__Path__init(&path_msg); }

  virtual void Fini() override { nav_msgs__msg__Path__fini(&path_msg); }
  ...
  void SetMsg(const FROSPath& Input) { Input.SetROS2(path_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSPath& Output) const { Output.SetFromROS2(path_msg); }

  virtual void* Get() override { return &path_msg; }
