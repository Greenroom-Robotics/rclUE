...
public:
  virtual void Init() override { sensor_msgs__msg__FluidPressure__init(&fluid_pressure_msg); }

  virtual void Fini() override { sensor_msgs__msg__FluidPressure__fini(&fluid_pressure_msg); }
  ...
  void SetMsg(const FROSFluidPressure& Input) { Input.SetROS2(fluid_pressure_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSFluidPressure& Output) const { Output.SetFromROS2(fluid_pressure_msg); }

  virtual void* Get() override { return &fluid_pressure_msg; }
