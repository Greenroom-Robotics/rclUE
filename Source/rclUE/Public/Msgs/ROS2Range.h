...
public:
  virtual void Init() override { sensor_msgs__msg__Range__init(&range_msg); }

  virtual void Fini() override { sensor_msgs__msg__Range__fini(&range_msg); }
  ...
  void SetMsg(const FROSRange& Input) { Input.SetROS2(range_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSRange& Output) const { Output.SetFromROS2(range_msg); }

  virtual void* Get() override { return &range_msg; }
