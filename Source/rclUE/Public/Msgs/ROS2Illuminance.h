...
public:
  virtual void Init() override { sensor_msgs__msg__Illuminance__init(&illuminance_msg); }

  virtual void Fini() override { sensor_msgs__msg__Illuminance__fini(&illuminance_msg); }
  ...
  void SetMsg(const FROSIlluminance& Input) { Input.SetROS2(illuminance_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSIlluminance& Output) const { Output.SetFromROS2(illuminance_msg); }

  virtual void* Get() override { return &illuminance_msg; }
