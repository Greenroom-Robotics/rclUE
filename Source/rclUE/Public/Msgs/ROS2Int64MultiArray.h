...
public:
  virtual void Init() override { example_interfaces__msg__Int64MultiArray__init(&int64_multi_array_msg); }

  virtual void Fini() override { example_interfaces__msg__Int64MultiArray__fini(&int64_multi_array_msg); }
  ...
  void SetMsg(const FROSInt64MultiArray& Input) { Input.SetROS2(int64_multi_array_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSInt64MultiArray& Output) const { Output.SetFromROS2(int64_multi_array_msg); }

  virtual void* Get() override { return &int64_multi_array_msg; }
