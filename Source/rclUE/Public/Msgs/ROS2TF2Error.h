...
public:
  virtual void Init() override { tf2_msgs__msg__TF2Error__init(&tf2_error_msg); }

  virtual void Fini() override { tf2_msgs__msg__TF2Error__fini(&tf2_error_msg); }
  ...
  void SetMsg(const FROSTF2Error& Input) { Input.SetROS2(tf2_error_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSTF2Error& Output) const { Output.SetFromROS2(tf2_error_msg); }

  virtual void* Get() override { return &tf2_error_msg; }
