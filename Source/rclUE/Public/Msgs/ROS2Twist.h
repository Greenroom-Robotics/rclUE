...
public:
  virtual void Init() override { geometry_msgs__msg__Twist__init(&twist_msg); }

  virtual void Fini() override { geometry_msgs__msg__Twist__fini(&twist_msg); }
  ...
  void SetMsg(const FROSTwist& Input) { Input.SetROS2(twist_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSTwist& Output) const { Output.SetFromROS2(twist_msg); }

  virtual void* Get() override { return &twist_msg; }
