...
public:
  virtual void Init() override { geographic_msgs__msg__GeoPoint__init(&geo_point_msg); }

  virtual void Fini() override { geographic_msgs__msg__GeoPoint__fini(&geo_point_msg); }
  ...
  void SetMsg(const FROSGeoPoint& Input) { Input.SetROS2(geo_point_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSGeoPoint& Output) const { Output.SetFromROS2(geo_point_msg); }

  virtual void* Get() override { return &geo_point_msg; }
