...
public:
  virtual void Init() override { geometry_msgs__msg__Pose__init(&pose_msg); }

  virtual void Fini() override { geometry_msgs__msg__Pose__fini(&pose_msg); }
  ...
  void SetMsg(const FROSPose& Input) { Input.SetROS2(pose_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSPose& Output) const { Output.SetFromROS2(pose_msg); }

  virtual void* Get() override { return &pose_msg; }
