...
public:
  ...
  void SetMsg(const FROSAccelWithCovarianceStamped& Input) { Input.SetROS2(accel_with_covariance_stamped_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSAccelWithCovarianceStamped& Output) const { Output.SetFromROS2(accel_with_covariance_stamped_msg); }

  virtual void* Get() override { return &accel_with_covariance_stamped_msg; }
