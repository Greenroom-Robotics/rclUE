...
public:
  virtual void Init() override { nav_msgs__msg__MapMetaData__init(&map_meta_data_msg); }

  virtual void Fini() override { nav_msgs__msg__MapMetaData__fini(&map_meta_data_msg); }
  ...
  void SetMsg(const FROSMapMetaData& Input) { Input.SetROS2(map_meta_data_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSMapMetaData& Output) const { Output.SetFromROS2(map_meta_data_msg); }

  virtual void* Get() override { return &map_meta_data_msg; }
