...
public:
  virtual void Init() override { example_interfaces__msg__UInt8MultiArray__init(&u_int8_multi_array_msg); }

  virtual void Fini() override { example_interfaces__msg__UInt8MultiArray__fini(&u_int8_multi_array_msg); }
  ...
  void SetMsg(const FROSUInt8MultiArray& Input) { Input.SetROS2(u_int8_multi_array_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSUInt8MultiArray& Output) const { Output.SetFromROS2(u_int8_multi_array_msg); }

  virtual void* Get() override { return &u_int8_multi_array_msg; }
