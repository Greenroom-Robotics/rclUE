...
public:
  virtual void Init() override { sensor_msgs__msg__TimeReference__init(&time_reference_msg); }

  virtual void Fini() override { sensor_msgs__msg__TimeReference__fini(&time_reference_msg); }
  ...
  void SetMsg(const FROSTimeReference& Input) { Input.SetROS2(time_reference_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSTimeReference& Output) const { Output.SetFromROS2(time_reference_msg); }

  virtual void* Get() override { return &time_reference_msg; }
