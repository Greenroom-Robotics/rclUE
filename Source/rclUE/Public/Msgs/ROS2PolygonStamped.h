...
public:
  virtual void Init() override { geometry_msgs__msg__PolygonStamped__init(&polygon_stamped_msg); }

  virtual void Fini() override { geometry_msgs__msg__PolygonStamped__fini(&polygon_stamped_msg); }
  ...
  void SetMsg(const FROSPolygonStamped& Input) { Input.SetROS2(polygon_stamped_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSPolygonStamped& Output) const { Output.SetFromROS2(polygon_stamped_msg); }

  virtual void* Get() override { return &polygon_stamped_msg; }
