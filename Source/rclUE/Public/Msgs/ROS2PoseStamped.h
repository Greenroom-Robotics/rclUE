...
public:
  virtual void Init() override { geometry_msgs__msg__PoseStamped__init(&pose_stamped_msg); }

  virtual void Fini() override { geometry_msgs__msg__PoseStamped__fini(&pose_stamped_msg); }
  ...
  void SetMsg(const FROSPoseStamped& Input) { Input.SetROS2(pose_stamped_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSPoseStamped& Output) const { Output.SetFromROS2(pose_stamped_msg); }

  virtual void* Get() override { return &pose_stamped_msg; }
