...
public:
  virtual void Init() override { builtin_interfaces__msg__Time__init(&time_msg); }

  virtual void Fini() override { builtin_interfaces__msg__Time__fini(&time_msg); }
  ...
  void SetMsg(const FROSTime& Input) { Input.SetROS2(time_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSTime& Output) const { Output.SetFromROS2(time_msg); }

  virtual void* Get() override { return &time_msg; }
