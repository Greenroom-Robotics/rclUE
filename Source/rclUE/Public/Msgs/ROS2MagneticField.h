...
public:
  virtual void Init() override { sensor_msgs__msg__MagneticField__init(&magnetic_field_msg); }

  virtual void Fini() override { sensor_msgs__msg__MagneticField__fini(&magnetic_field_msg); }
  ...
  void SetMsg(const FROSMagneticField& Input) { Input.SetROS2(magnetic_field_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSMagneticField& Output) const { Output.SetFromROS2(magnetic_field_msg); }

  virtual void* Get() override { return &magnetic_field_msg; }
