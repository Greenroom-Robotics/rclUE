...
public:
  virtual void Init() override { geographic_msgs__msg__KeyValue__init(&key_value_msg); }

  virtual void Fini() override { geographic_msgs__msg__KeyValue__fini(&key_value_msg); }
  ...
  void SetMsg(const FROSKeyValue& Input) { Input.SetROS2(key_value_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSKeyValue& Output) const { Output.SetFromROS2(key_value_msg); }

  virtual void* Get() override { return &key_value_msg; }
