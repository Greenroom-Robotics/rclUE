...
public:
  virtual void Init() override { sensor_msgs__msg__MultiDOFJointState__init(&multi_dof_joint_state_msg); }

  virtual void Fini() override { sensor_msgs__msg__MultiDOFJointState__fini(&multi_dof_joint_state_msg); }
  ...
  void SetMsg(const FROSMultiDOFJointState& Input) { Input.SetROS2(multi_dof_joint_state_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSMultiDOFJointState& Output) const { Output.SetFromROS2(multi_dof_joint_state_msg); }

  virtual void* Get() override { return &multi_dof_joint_state_msg; }
