...
public:
  virtual void Init() override { builtin_interfaces__msg__Duration__init(&duration_msg); }

  virtual void Fini() override { builtin_interfaces__msg__Duration__fini(&duration_msg); }
  ...
  void SetMsg(const FROSDuration& Input) { Input.SetROS2(duration_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSDuration& Output) const { Output.SetFromROS2(duration_msg); }

  virtual void* Get() override { return &duration_msg; }
