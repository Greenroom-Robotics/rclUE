...
public:
  virtual void Init() override { sensor_msgs__msg__MultiEchoLaserScan__init(&multi_echo_laser_scan_msg); }

  virtual void Fini() override { sensor_msgs__msg__MultiEchoLaserScan__fini(&multi_echo_laser_scan_msg); }
  ...
  void SetMsg(const FROSMultiEchoLaserScan& Input) { Input.SetROS2(multi_echo_laser_scan_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSMultiEchoLaserScan& Output) const { Output.SetFromROS2(multi_echo_laser_scan_msg); }

  virtual void* Get() override { return &multi_echo_laser_scan_msg; }
