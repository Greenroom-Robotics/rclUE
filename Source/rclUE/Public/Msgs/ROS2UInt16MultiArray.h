...
public:
  virtual void Init() override { example_interfaces__msg__UInt16MultiArray__init(&u_int16_multi_array_msg); }

  virtual void Fini() override { example_interfaces__msg__UInt16MultiArray__fini(&u_int16_multi_array_msg); }
  ...
  void SetMsg(const FROSUInt16MultiArray& Input) { Input.SetROS2(u_int16_multi_array_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSUInt16MultiArray& Output) const { Output.SetFromROS2(u_int16_multi_array_msg); }

  virtual void* Get() override { return &u_int16_multi_array_msg; }
