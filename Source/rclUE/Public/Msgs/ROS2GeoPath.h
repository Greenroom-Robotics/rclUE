...
public:
  virtual void Init() override { geographic_msgs__msg__GeoPath__init(&geo_path_msg); }

  virtual void Fini() override { geographic_msgs__msg__GeoPath__fini(&geo_path_msg); }
  ...
  void SetMsg(const FROSGeoPath& Input) { Input.SetROS2(geo_path_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSGeoPath& Output) const { Output.SetFromROS2(geo_path_msg); }

  virtual void* Get() override { return &geo_path_msg; }
