...
public:
  ...
  UPROPERTY(EditAnywhere, BlueprintReadWrite)
  UROSNavSatFixPositionCovarianceTypeEnum position_covariance_type =
      UROSNavSatFixPositionCovarianceTypeEnum::COVARIANCE_TYPE_UNKNOWN;
  ...
  void SetFromROS2(const ros_msg_c_typename& in_ros_data)
  {
    ...
    position_covariance_type =
        static_cast<UROSNavSatFixPositionCovarianceTypeEnum>(in_ros_data.position_covariance_type);
  }
...
public:
  virtual void Init() override { sensor_msgs__msg__NavSatFix__init(&nav_sat_fix_msg); }

  virtual void Fini() override { sensor_msgs__msg__NavSatFix__fini(&nav_sat_fix_msg); }
  ...
  void SetMsg(const FROSNavSatFix& Input) { Input.SetROS2(nav_sat_fix_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSNavSatFix& Output) const { Output.SetFromROS2(nav_sat_fix_msg); }

  virtual void* Get() override { return &nav_sat_fix_msg; }
