...
public:
  virtual void Init() override { geographic_msgs__msg__RoutePath__init(&route_path_msg); }

  virtual void Fini() override { geographic_msgs__msg__RoutePath__fini(&route_path_msg); }
  ...
  void SetMsg(const FROSRoutePath& Input) { Input.SetROS2(route_path_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSRoutePath& Output) const { Output.SetFromROS2(route_path_msg); }

  virtual void* Get() override { return &route_path_msg; }
