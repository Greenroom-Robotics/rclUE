...
public:
  virtual void Init() override { example_interfaces__msg__Float64MultiArray__init(&float64_multi_array_msg); }

  virtual void Fini() override { example_interfaces__msg__Float64MultiArray__fini(&float64_multi_array_msg); }
  ...
  void SetMsg(const FROSFloat64MultiArray& Input) { Input.SetROS2(float64_multi_array_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSFloat64MultiArray& Output) const { Output.SetFromROS2(float64_multi_array_msg); }

  virtual void* Get() override { return &float64_multi_array_msg; }
