...
public:
  virtual void Init() override { example_interfaces__msg__MultiArrayDimension__init(&multi_array_dimension_msg); }

  virtual void Fini() override { example_interfaces__msg__MultiArrayDimension__fini(&multi_array_dimension_msg); }
  ...
  void SetMsg(const FROSMultiArrayDimension& Input) { Input.SetROS2(multi_array_dimension_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSMultiArrayDimension& Output) const { Output.SetFromROS2(multi_array_dimension_msg); }

  virtual void* Get() override { return &multi_array_dimension_msg; }
