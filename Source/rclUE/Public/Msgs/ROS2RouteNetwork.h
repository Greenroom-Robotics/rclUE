...
public:
  virtual void Init() override { geographic_msgs__msg__RouteNetwork__init(&route_network_msg); }

  virtual void Fini() override { geographic_msgs__msg__RouteNetwork__fini(&route_network_msg); }
  ...
  void SetMsg(const FROSRouteNetwork& Input) { Input.SetROS2(route_network_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSRouteNetwork& Output) const { Output.SetFromROS2(route_network_msg); }

  virtual void* Get() override { return &route_network_msg; }
