...
public:
  virtual void Init() override { sensor_msgs__msg__ChannelFloat32__init(&channel_float32_msg); }

  virtual void Fini() override { sensor_msgs__msg__ChannelFloat32__fini(&channel_float32_msg); }
  ...
  void SetMsg(const FROSChannelFloat32& Input) { Input.SetROS2(channel_float32_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSChannelFloat32& Output) const { Output.SetFromROS2(channel_float32_msg); }

  virtual void* Get() override { return &channel_float32_msg; }
