...
public:
  virtual void Init() override { geometry_msgs__msg__Transform__init(&transform_msg); }

  virtual void Fini() override { geometry_msgs__msg__Transform__fini(&transform_msg); }
  ...
  void SetMsg(const FROSTransform& Input) { Input.SetROS2(transform_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSTransform& Output) const { Output.SetFromROS2(transform_msg); }

  virtual void* Get() override { return &transform_msg; }
