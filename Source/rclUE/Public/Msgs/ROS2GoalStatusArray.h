...
public:
  virtual void Init() override { action_msgs__msg__GoalStatusArray__init(&goal_status_array_msg); }

  virtual void Fini() override { action_msgs__msg__GoalStatusArray__fini(&goal_status_array_msg); }
  ...
  void SetMsg(const FROSGoalStatusArray& Input) { Input.SetROS2(goal_status_array_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSGoalStatusArray& Output) const { Output.SetFromROS2(goal_status_array_msg); }

  virtual void* Get() override { return &goal_status_array_msg; }
