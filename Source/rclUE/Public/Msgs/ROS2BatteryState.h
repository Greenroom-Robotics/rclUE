...
public:
  ...
  UPROPERTY(EditAnywhere, BlueprintReadWrite)
  UROSBatteryStatePowerSupplyStatusEnum power_supply_status =
      UROSBatteryStatePowerSupplyStatusEnum::POWER_SUPPLY_STATUS_UNKNOWN;
  // rclc type: uint8_t power_supply_status

  UPROPERTY(EditAnywhere, BlueprintReadWrite)
  UROSBatteryStatePowerSupplyHealthEnum power_supply_health =
      UROSBatteryStatePowerSupplyHealthEnum::POWER_SUPPLY_HEALTH_UNKNOWN;
  // rclc type: uint8_t power_supply_health

  UPROPERTY(EditAnywhere, BlueprintReadWrite)
  UROSBatteryStatePowerSupplyTechnologyEnum power_supply_technology =
      UROSBatteryStatePowerSupplyTechnologyEnum::POWER_SUPPLY_TECHNOLOGY_UNKNOWN;
  ...
  void SetFromROS2(const ros_msg_c_typename& in_ros_data)
  {
    ...
    power_supply_technology =
        static_cast<UROSBatteryStatePowerSupplyTechnologyEnum>(in_ros_data.power_supply_technology);
...
public:
  virtual void Init() override { sensor_msgs__msg__BatteryState__init(&battery_state_msg); }

  virtual void Fini() override { sensor_msgs__msg__BatteryState__fini(&battery_state_msg); }
  ...
  void SetMsg(const FROSBatteryState& Input) { Input.SetROS2(battery_state_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSBatteryState& Output) const { Output.SetFromROS2(battery_state_msg); }

  virtual void* Get() override { return &battery_state_msg; }
