...
public:
  virtual void Init() override { geometry_msgs__msg__Inertia__init(&inertia_msg); }

  virtual void Fini() override { geometry_msgs__msg__Inertia__fini(&inertia_msg); }
  ...
  void SetMsg(const FROSInertia& Input) { Input.SetROS2(inertia_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSInertia& Output) const { Output.SetFromROS2(inertia_msg); }

  virtual void* Get() override { return &inertia_msg; }
