...
public:
  virtual void Init() override { geometry_msgs__msg__AccelWithCovariance__init(&accel_with_covariance_msg); }

  virtual void Fini() override { geometry_msgs__msg__AccelWithCovariance__fini(&accel_with_covariance_msg); }
  ...
  void SetMsg(const FROSAccelWithCovariance& Input) { Input.SetROS2(accel_with_covariance_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSAccelWithCovariance& Output) const { Output.SetFromROS2(accel_with_covariance_msg); }

  virtual void* Get() override { return &accel_with_covariance_msg; }
