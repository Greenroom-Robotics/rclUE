...
public:
  virtual void Init() override { geographic_msgs__msg__GeoPoseWithCovariance__init(&geo_pose_with_covariance_msg); }

  virtual void Fini() override { geographic_msgs__msg__GeoPoseWithCovariance__fini(&geo_pose_with_covariance_msg); }
  ...
  void SetMsg(const FROSGeoPoseWithCovariance& Input) { Input.SetROS2(geo_pose_with_covariance_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSGeoPoseWithCovariance& Output) const { Output.SetFromROS2(geo_pose_with_covariance_msg); }

  virtual void* Get() override { return &geo_pose_with_covariance_msg; }
