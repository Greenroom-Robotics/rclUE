...
public:
  virtual void Init() override { sensor_msgs__msg__Temperature__init(&temperature_msg); }

  virtual void Fini() override { sensor_msgs__msg__Temperature__fini(&temperature_msg); }
  ...
  void SetMsg(const FROSTemperature& Input) { Input.SetROS2(temperature_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSTemperature& Output) const { Output.SetFromROS2(temperature_msg); }

  virtual void* Get() override { return &temperature_msg; }
