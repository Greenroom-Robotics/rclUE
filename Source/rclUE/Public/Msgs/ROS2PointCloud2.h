...
public:
  virtual void Init() override { sensor_msgs__msg__PointCloud2__init(&point_cloud2_msg); }

  virtual void Fini() override { sensor_msgs__msg__PointCloud2__fini(&point_cloud2_msg); }
  ...
  void SetMsg(const FROSPointCloud2& Input) { Input.SetROS2(point_cloud2_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSPointCloud2& Output) const { Output.SetFromROS2(point_cloud2_msg); }

  virtual void* Get() override { return &point_cloud2_msg; }
