...
public:
  virtual void Init() override { sensor_msgs__msg__CameraInfo__init(&camera_info_msg); }

  virtual void Fini() override { sensor_msgs__msg__CameraInfo__fini(&camera_info_msg); }
  ...
  void SetMsg(const FROSCameraInfo& Input) { Input.SetROS2(camera_info_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSCameraInfo& Output) const { Output.SetFromROS2(camera_info_msg); }

  virtual void* Get() override { return &camera_info_msg; }
