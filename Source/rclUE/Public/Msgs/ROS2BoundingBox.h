...
public:
  virtual void Init() override { geographic_msgs__msg__BoundingBox__init(&bounding_box_msg); }

  virtual void Fini() override { geographic_msgs__msg__BoundingBox__fini(&bounding_box_msg); }
  ...
  void SetMsg(const FROSBoundingBox& Input) { Input.SetROS2(bounding_box_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSBoundingBox& Output) const { Output.SetFromROS2(bounding_box_msg); }

  virtual void* Get() override { return &bounding_box_msg; }
