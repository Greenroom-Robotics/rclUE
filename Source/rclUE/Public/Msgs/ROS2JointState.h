...
public:
  virtual void Init() override { sensor_msgs__msg__JointState__init(&joint_state_msg); }

  virtual void Fini() override { sensor_msgs__msg__JointState__fini(&joint_state_msg); }
  ...
  void SetMsg(const FROSJointState& Input) { Input.SetROS2(joint_state_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSJointState& Output) const { Output.SetFromROS2(joint_state_msg); }

  virtual void* Get() override { return &joint_state_msg; }
