...
public:
  virtual void Init() override { sensor_msgs__msg__PointField__init(&point_field_msg); }

  virtual void Fini() override { sensor_msgs__msg__PointField__fini(&point_field_msg); }
  ...
  void SetMsg(const FROSPointField& Input) { Input.SetROS2(point_field_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSPointField& Output) const { Output.SetFromROS2(point_field_msg); }

  virtual void* Get() override { return &point_field_msg; }
