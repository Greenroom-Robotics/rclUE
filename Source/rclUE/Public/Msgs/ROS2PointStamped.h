...
public:
  virtual void Init() override { geometry_msgs__msg__PointStamped__init(&point_stamped_msg); }

  virtual void Fini() override { geometry_msgs__msg__PointStamped__fini(&point_stamped_msg); }
  ...
  void SetMsg(const FROSPointStamped& Input) { Input.SetROS2(point_stamped_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSPointStamped& Output) const { Output.SetFromROS2(point_stamped_msg); }

  virtual void* Get() override { return &point_stamped_msg; }
