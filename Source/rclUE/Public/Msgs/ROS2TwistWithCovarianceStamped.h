...
public:
  ...
  void SetMsg(const FROSTwistWithCovarianceStamped& Input) { Input.SetROS2(twist_with_covariance_stamped_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSTwistWithCovarianceStamped& Output) const { Output.SetFromROS2(twist_with_covariance_stamped_msg); }

  virtual void* Get() override { return &twist_with_covariance_stamped_msg; }
