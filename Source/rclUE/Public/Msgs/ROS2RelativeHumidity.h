...
public:
  virtual void Init() override { sensor_msgs__msg__RelativeHumidity__init(&relative_humidity_msg); }

  virtual void Fini() override { sensor_msgs__msg__RelativeHumidity__fini(&relative_humidity_msg); }
  ...
  void SetMsg(const FROSRelativeHumidity& Input) { Input.SetROS2(relative_humidity_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSRelativeHumidity& Output) const { Output.SetFromROS2(relative_humidity_msg); }

  virtual void* Get() override { return &relative_humidity_msg; }
