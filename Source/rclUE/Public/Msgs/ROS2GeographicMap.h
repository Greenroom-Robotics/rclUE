...
public:
  virtual void Init() override { geographic_msgs__msg__GeographicMap__init(&geographic_map_msg); }

  virtual void Fini() override { geographic_msgs__msg__GeographicMap__fini(&geographic_map_msg); }
  ...
  void SetMsg(const FROSGeographicMap& Input) { Input.SetROS2(geographic_map_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSGeographicMap& Output) const { Output.SetFromROS2(geographic_map_msg); }

  virtual void* Get() override { return &geographic_map_msg; }
