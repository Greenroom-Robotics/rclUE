...
public:
  virtual void Init() override { sensor_msgs__msg__PointCloud__init(&point_cloud_msg); }

  virtual void Fini() override { sensor_msgs__msg__PointCloud__fini(&point_cloud_msg); }
  ...
  void SetMsg(const FROSPointCloud& Input) { Input.SetROS2(point_cloud_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSPointCloud& Output) const { Output.SetFromROS2(point_cloud_msg); }

  virtual void* Get() override { return &point_cloud_msg; }
