...
public:
  virtual void Init() override { geometry_msgs__msg__Vector3Stamped__init(&vector3_stamped_msg); }

  virtual void Fini() override { geometry_msgs__msg__Vector3Stamped__fini(&vector3_stamped_msg); }
  ...
  void SetMsg(const FROSVector3Stamped& Input) { Input.SetROS2(vector3_stamped_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSVector3Stamped& Output) const { Output.SetFromROS2(vector3_stamped_msg); }

  virtual void* Get() override { return &vector3_stamped_msg; }
