...
public:
  virtual void Init() override { tf2_msgs__msg__TFMessage__init(&tf_message_msg); }

  virtual void Fini() override { tf2_msgs__msg__TFMessage__fini(&tf_message_msg); }
  ...
  void SetMsg(const FROSTFMessage& Input) { Input.SetROS2(tf_message_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSTFMessage& Output) const { Output.SetFromROS2(tf_message_msg); }

  virtual void* Get() override { return &tf_message_msg; }
