...
public:
  virtual void Init() override { geographic_msgs__msg__MapFeature__init(&map_feature_msg); }

  virtual void Fini() override { geographic_msgs__msg__MapFeature__fini(&map_feature_msg); }
  ...
  void SetMsg(const FROSMapFeature& Input) { Input.SetROS2(map_feature_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSMapFeature& Output) const { Output.SetFromROS2(map_feature_msg); }

  virtual void* Get() override { return &map_feature_msg; }
