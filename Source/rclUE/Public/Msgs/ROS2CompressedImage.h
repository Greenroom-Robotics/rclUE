...
public:
  virtual void Init() override { sensor_msgs__msg__CompressedImage__init(&compressed_image_msg); }

  virtual void Fini() override { sensor_msgs__msg__CompressedImage__fini(&compressed_image_msg); }
  ...
  void SetMsg(const FROSCompressedImage& Input) { Input.SetROS2(compressed_image_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSCompressedImage& Output) const { Output.SetFromROS2(compressed_image_msg); }

  virtual void* Get() override { return &compressed_image_msg; }
