...
public:
  virtual void Init() override { action_msgs__msg__GoalStatus__init(&goal_status_msg); }

  virtual void Fini() override { action_msgs__msg__GoalStatus__fini(&goal_status_msg); }
  ...
  void SetMsg(const FROSGoalStatus& Input) { Input.SetROS2(goal_status_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSGoalStatus& Output) const { Output.SetFromROS2(goal_status_msg); }

  virtual void* Get() override { return &goal_status_msg; }
