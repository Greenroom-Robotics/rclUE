...
public:
  virtual void Init() override { example_interfaces__msg__UInt32MultiArray__init(&u_int32_multi_array_msg); }

  virtual void Fini() override { example_interfaces__msg__UInt32MultiArray__fini(&u_int32_multi_array_msg); }
  ...
  void SetMsg(const FROSUInt32MultiArray& Input) { Input.SetROS2(u_int32_multi_array_msg); }

  UFUNCTION(BlueprintCallable)
  void GetMsg(FROSUInt32MultiArray& Output) const { Output.SetFromROS2(u_int32_multi_array_msg); }

  virtual void* Get() override { return &u_int32_multi_array_msg; }
