...
public:
  ...
  void AddServiceServer(const FString& ServiceName, const TSubclassOf<UROS2GenericSrv> SrvClass,
  ...
  FCriticalSection* GetMutex() { return &(ROSSubsystem()->RCLCritical); }

  rcl_node_t* GetRCLNode() { return &_rcl_node; }
