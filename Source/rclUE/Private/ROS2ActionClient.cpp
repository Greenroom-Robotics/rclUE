...
void UROS2ActionClient::InitializeActionComponent(const UROS2QoS QoS)
{
  ...
  rcl_ret_t rc = rcl_action_client_init(&client, NodeSubsystem->GetRCLNode(), action_type_support,
                                        TCHAR_TO_UTF8(*ActionName), &client_opt);
}
...
void UROS2ActionClient::ProcessReady(rcl_wait_set_t* wait_set)
{
  ...
  RCSOFTCHECK(rcl_action_client_wait_set_get_entities_ready(wait_set, &client, &IsReady[0], &IsReady[1], &IsReady[2],
                                                            &IsReady[3], &IsReady[4]));
...
void UROS2ActionClient::CancelActionRequest()
{
  ...
  action_msgs__srv__CancelGoal_Request* cancel_request =
      (action_msgs__srv__CancelGoal_Request*)Action->GetCancelRequest();
...
void UROS2ActionClient::SetDelegates(const FActionCallback& SetGoal, const FActionCallback& Feedback,
                                     const FActionCallback& Result, const FSimpleCallback& GoalResponse,
