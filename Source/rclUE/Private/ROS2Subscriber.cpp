...
void UROS2Subscriber::Init()
{
  ...
  if (State == UROS2State::Created)
  {
    ...
    {
      UE_LOG(LogROS2Subscriber, Error,
    ...
    RCSOFTCHECK(rcl_subscription_init(&rcl_subscription, NodeSubsystem->GetRCLNode(), TopicMessage->GetTypeSupport(),
                                      TCHAR_TO_UTF8(*TopicName), &sub_opt));
